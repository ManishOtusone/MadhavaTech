                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8 mt-10">
                    {[
                        ...
                        },
                        {
                            ...
                            desc: "We offer cost-effective IT solutions that deliver maximum value for your investment, helping you optimize your IT budget.",
                        },
                        {
                            title: "Customer-centric Approach",
                            desc: "We prioritize customer satisfaction and ensure clear communication, responsiveness, and ongoing support throughout our engagement.",
                        },
                        {
                            title: "24/7 Support",
                            desc: "Our dedicated support team is available 24/7 to address any IT issues or concerns, providing peace of mind and ensuring continuous operations.",
                        },
                    ].map((item, index) => (
                        <div
                            key={index}
                        ...
                        >
                            {/* Icon Box */}
                            <div div className="bg-gray-300 h-[40px] w-[60px] sm:h-[50px] sm:w-[60px] rounded-md mt-1 shrink-0" ></div>
                ...
                <div className="py-12 px-4 sm:px-6 lg:px-16 bg-[#f9f9f9]">
                    <div className="text-center max-w-4xl mx-auto mb-10">
                        ...
                        <p className="text-[#808080] text-sm sm:text-base">
                            "From concept to creation, we specialize in bringing your ideas to life. With our expertise and <br className="hidden sm:block" />
                            dedication, we turn your visions into tangible successes, empowering you to thrive in your endeavors."
                        </p>
                    </div>
